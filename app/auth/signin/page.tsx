      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 border border-slate-700 rounded-sm p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full mb-6 flex items-center justify-center gap-3 px-4 py-3 bg-white text-slate-950 font-bold rounded-sm hover:bg-slate-100 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-slate-900 text-slate-500 font-medium">or</span>
            </div>
          </div>

          {/* Info Box */}
          <div className="p-4 bg-slate-800 border border-slate-700 rounded-sm text-sm text-slate-400 mb-6">
            <p className="mb-2 font-bold text-slate-300">Supported Methods:</p>
        ...
        <p className="text-center text-slate-500 text-[10px] uppercase tracking-widest mt-8 font-bold">
          Protected by Enterprise-Grade RLS Security
        </p>
      </div>
    </div>
  );
